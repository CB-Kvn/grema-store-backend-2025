...
class OthersKitService {
    constructor() {
        if (!config_1.config.IMAGEKIT_PUBLIC_KEY_OTHERS || !config_1.config.IMAGEKIT_PRIVATE_KEY_OTHERS || !config_1.config.IMAGEKIT_URL_ENDPOINT_OTHERS) {
            throw new Error("Faltan variables de entorno para ImageKit.");
        }
        this.imagekit = new imagekit_1.default({
            publicKey: config_1.config.IMAGEKIT_PUBLIC_KEY_OTHERS,
            privateKey: config_1.config.IMAGEKIT_PRIVATE_KEY_OTHERS,
            urlEndpoint: config_1.config.IMAGEKIT_URL_ENDPOINT_OTHERS,
        });
    }
...
exports.default = OthersKitService;
